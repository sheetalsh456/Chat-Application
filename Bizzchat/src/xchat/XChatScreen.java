...
public class XChatScreen extends javax.swing.JFrame implements Runnable {
    ...
    private void add_send(String msg) {
        //Creates labels and aligns to the right
        JLabel l = new JLabel();
        list.add(l);
        l.setFont(font_cur);
    ...
    private void add_rec(String received) {
        //Creates labels and aligns to the left
        try{
        JLabel l = new JLabel();
        list.add(l);
        l.setFont(font_cur);
        ...
        try {
            ...
            //(BUG)//https://netbeans.org/bugzilla/show_bug.cgi?id=181477
        }
        loc += l.getMaximumSize().height + 10;
        jScrollPane3.revalidate();
        jPanel2.repaint();
    ...
    public void setMyName(String my_name) {
        ...
        this.setTitle("XChat Connected: " + this.my_name);
        change_name();
    }
    ...
    private void initComponents() {
        ...
        new FileDrop(System.out, jPanel1, new FileDrop.Listener() {
            @Override
    ...
    private void jEditorPane1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jEditorPane1KeyPressed
        //SENDING OF MESSAGE WHEN ENTER IS PRESSED
        String msg = this.jEditorPane1.getText();
        msg = msg.replaceAll("(\r\n)+", "");
        if (evt.getKeyCode() == KeyEvent.VK_ENTER && !msg.equals("") && !msg.equals("\r\n")) {
            ...
            evt.consume();//Keeps the cursor position on the first line
            ...
            try {
                ...
                if (received != null && !received.equals("") && !received.equals("\r\n")) {
                    if (received.contains("~!!FILE!!~")) {
                        ...
                        int pos = filename.lastIndexOf("~");
                        filename = filename.substring(pos + 1);
                        FileOutputStream fileOutputStream = new FileOutputStream("profile" + filename.substring(filename.lastIndexOf(".")));
                        fileOutputStream.write(message);
                        fileOutputStream.close();
    ...
    public void sendImage(File imgsrc) {
        try {
