...
{
    // converts object state to serial bytes
     ...
     *  listener Listens for <tt>filesDropped</tt>.
     * @since 1.0
     */
    public FileDrop(
    final java.io.PrintStream out,
     ...
     *
     *  c Component on which files will be dropped.
     *  dragBorder Border to use on <tt>JComponent</tt> when dragging occurs.
     *  listener Listens for <tt>filesDropped</tt>.
     * @since 1.0
     */
    public FileDrop(
    ...
    {   
        ...
        if( supportsDnD() ) // supports drag and drop
     ...
     * components after you've set up the drag-and-drop.
     *
     *  out Optional {@link java.io.PrintStream} for logging drag and drop messages
...
/* ********  I N N E R   I N T E R F A C E   L I S T E N E R  ******** */    
    ...
    public static interface Listener {
         ...
         *
         *  files An array of <tt>File</tt>s that were dropped.
         */
